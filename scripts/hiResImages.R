...
plot(x = urban.water, xlab = "% Urban Access to Clean Water", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ urban.water)), lwd = LWD, col = "firebrick")
g <- dev.off()
...
plot(x = methane, xlab = "Methane Emissions (kt)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ methane)), lwd = LWD, col = "firebrick")

plot(x = nitrous, xlab = "Nitrous Emissions (kt)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ nitrous)), lwd = LWD, col = "firebrick")

plot(x = log.co2, xlab = "log CO2 Emissions (kt)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.co2)), lwd = LWD, col = "firebrick")

plot(x = log.methane, xlab = "log Methane Emissions (kt)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.methane)), lwd = LWD, col = "firebrick")

plot(x = log.nitrous, xlab = "log Nitrous Emissions (kt)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.nitrous)), lwd = LWD, col = "firebrick")
g <- dev.off()
...
plot(x = paved.roads, xlab = "Paved Roads (% of total)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ paved.roads)), lwd = LWD, col = "firebrick")

plot(x = log.electricity.consumption, xlab = "log Electricity Consumption", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.electricity.consumption)), lwd = LWD, col = "firebrick")

plot(x = log.paved.roads, xlab = "log Paved Roads (% of total)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.paved.roads)), lwd = LWD, col = "firebrick")
g <- dev.off()
...
plot(x = research, xlab = "R&D Expenditure (% of GDP)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ research)), lwd = LWD, col = "firebrick")

plot(x = journals, xlab = "Science Journals", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ journals)), lwd = LWD, col = "firebrick")

plot(x = log.high.tech, xlab = "log High-tech exports (% of manufactured exports)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.high.tech)), lwd = LWD, col = "firebrick")

plot(x = log.research, xlab = "log R&D Expenditure (% of GDP)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.research)), lwd = LWD, col = "firebrick")

plot(x = log.journals, xlab = "log Science Journals", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(summary(lm(log.GDP.per.capita ~ log.journals)), lwd = LWD, col = "firebrick")
g <- dev.off()
...
plot(x = life.expect, xlab = "Life expectancy at birth, male (years)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ life.expect), lwd = LWD, col = "firebrick")

plot(x = refugees, xlab = "Refugee Population", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ refugees), lwd = LWD, col = "firebrick")

plot(x = literacy, xlab = "Literacy Rate (adult total)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ literacy), lwd = LWD, col = "firebrick")

plot(x = log.child.labor, xlab = "log Child Employment (% of chlidren ages 7-14)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ log.child.labor), lwd = LWD, col = "firebrick")

plot(x = log.life.expect, xlab = "log Life expectancy at birth, male (years)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ log.life.expect), lwd = LWD, col = "firebrick")

plot(x = log.refugees, xlab = "log Refugee Population", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ log.refugees), lwd = LWD, col = "firebrick")

plot(x = log.literacy, xlab = "log Literacy Rate (adult total)", y = log.GDP.per.capita, ylab = "log(GDP per capita)", pch = PCH, cex = CEX, col = "darkblue")
abline(lm(log.GDP.per.capita ~ log.literacy), lwd = LWD, col = "firebrick")
g <- dev.off()
