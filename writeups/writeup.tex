...
For welfare, we use the percentage of the urban population with access to clean water.

In Figure~\ref{urban_model_scatter_pop_water}, we make scatterplots of log GDP per capita versus population and water.
...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{images/urban_model_scatter_san}
...
Figure~\ref{urban_model_regressions} shows our variations of the urban model.
